// components/modal/TransferModal.jsx
      ...
      <div className="transfer-modal-overlay">
        ...
        >
          ...
          <div className="transfer-modal-header">
            <h2 id="transfer-modal-title">Transfer Custodian</h2>
            <button
          ...
          <div className="transfer-modal-body">
            ...
            <div className="modal-info">
              ...
              <p className="info-text">
                Find the asset and the receiving custodian first — both
                custodians will need to acknowledge the transfer before it's
                completed.
              </p>
            </div>
          </div>
